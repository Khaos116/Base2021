object Versions {
  ...
  internal const val sdkTarget = 29
...
object Deps {
  ...
  const val plugin_r8_gradle = "com.android.tools:r8:2.0.99" //更新R8版本，解决正式版无法打包的问题 https://github.com/square/okhttp/issues/4604
  ...
  const val permissionx = "com.permissionx.guolindev:permissionx:1.3.0"
  ...
  const val svga = "com.github.yyued:SVGAPlayer-Android:2.5.8"
}