 ...
 * Time:19:03
 */
class VideoTimeUtils private constructor() {
  private object SingletonHolder {
    val holder = VideoTimeUtils()
  }
  ...
  fun forMatterVideoTime(timeMillSeconds: Long): String {
  ...
  fun forMatterVideoTimeSeek(timeSeconds: Long): String {
